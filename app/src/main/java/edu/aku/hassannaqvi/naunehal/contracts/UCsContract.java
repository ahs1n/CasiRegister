...
public class UCsContract {
    ...
    public UCsContract Sync(JSONObject jsonObject) throws JSONException {
        this.uc_code = jsonObject.getString(TableUCs.COLUMN_UC_CODE);
        this.uc_name = jsonObject.getString(TableUCs.COLUMN_UC_NAME);
        this.tehsil_code = jsonObject.getString(TableUCs.COLUMN_TEHSIL_CODE);
        return this;
    }

    public UCsContract HydrateUCs(Cursor cursor) {
        this.uc_code = cursor.getString(cursor.getColumnIndex(TableUCs.COLUMN_UC_CODE));
        this.uc_name = cursor.getString(cursor.getColumnIndex(TableUCs.COLUMN_UC_NAME));
        this.tehsil_code = cursor.getString(cursor.getColumnIndex(TableUCs.COLUMN_TEHSIL_CODE));
        return this;
    }
    ...
    public JSONObject toJSONObject() throws JSONException {
        ...
        json.put(TableUCs.COLUMN_UC_CODE, this.uc_code == null ? JSONObject.NULL : this.uc_code);
        json.put(TableUCs.COLUMN_UC_NAME, this.uc_name == null ? JSONObject.NULL : this.uc_name);
        json.put(TableUCs.COLUMN_TEHSIL_CODE, this.tehsil_code == null ? JSONObject.NULL : this.tehsil_code);
        return json;
    }
