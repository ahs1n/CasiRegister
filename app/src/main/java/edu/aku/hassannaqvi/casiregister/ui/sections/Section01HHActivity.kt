...
import edu.aku.hassannaqvi.casiregister.databinding.ActivitySection01hhBinding
...
class Section01HHActivity : AppCompatActivity() {
    ...
    private fun updateDB(): Boolean {
        ...
        return if (updcount > 0) {
            ...
            if (count > 0) count = db.updatesFormColumn(FormsContract.FormsTable.COLUMN_S01CS, MainApp.form.s01HH)
